...
class InstanceResource:
    ...
    ROW_DATA_WAON_PAYMENT_ITABASHIMAENOCHO = WAON_ROW_DATA_FACTORY.create(["2018/8/30", "板橋前野町", "1,489円", "支払", "-"])
    ...
    ROW_DATA_MUFG_INCOME_CARD = MUFG_ROW_DATA_FACTORY.create(
        ["2018/10/1", "カ−ド", "", "", "10000", "3000000", "", "", "入金"]
    )
    ...
    ROW_DATA_MUFG_PAYMENT = MUFG_ROW_DATA_FACTORY.create(
        ["2018/11/5", "カ−ド", "", "9000", "", "4000000", "", "", "支払い"]
    )
