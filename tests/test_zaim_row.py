...
class TestZaimPaymentRow:
    ...
    @pytest.mark.parametrize(
        (
            ...
            (AmazonRowFactory(), InstanceResource.ROW_DATA_AMAZON_ECHO_DOT,
    ...
    def test_all(yaml_config_load, database_session_stores_item, input_row_factory,
...
class TestZaimRowFactory:
    ...
    def test_success(yaml_config_load, database_session_with_schema, zaim_row_converter_class, input_row, waon_row_data,
        ...
        assert isinstance(
            ZaimRowFactory.create(zaim_row_converter_class(input_row(waon_row_data))), expected
        )
